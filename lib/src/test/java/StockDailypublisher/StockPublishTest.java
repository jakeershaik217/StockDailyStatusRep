...
public class StockPublishTest {
	...
	public Object[][] getMarketCapRange(){
		...
		Maps.put("Range2", 50000);
		HashMapData[3][0]=Maps;
		
		Maps=new HashMap<String, Integer>();
		Maps.put("Range1", 50000);
	...
	public void RunTesToFectStocks(HashMap<String, Integer> Maps) {
	...
	public  String composeEmailBody() {
		String Body="<tbody>";
		List<String> SlabList=new ArrayList<>(Arrays.asList(new String[] {"4.99","5.0","9.99","10.0","19.99","20.0"}));
		
		for(HashMap<String,Object> Maps:CompnayFinalData) 
			if(SlabList.contains(Maps.get("Company ID")))
